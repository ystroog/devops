        ...
        stage('Ansible Playbook') {
            ...
            steps {
                script {
                    ...
                    sh "echo $HOST >> hosts"
                    sh "ansible-playbook -i hosts  -u centos -b --private-key=/var/jenkins_home/ansible/my.pem /var/jenkins_home/workspace/jenkinsfile_ansible/dockerplaybook.yml -vvvv"
                    sh 'rm hosts'
                }
            }
        }
